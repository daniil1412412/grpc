...
func (x *AuthRequest) GetAppId() int64 {
	if x != nil {
		return x.AppId
	}
	return 0
...
func (x *AuthResponce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthResponce) ProtoMessage() {}

func (x *AuthResponce) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthResponce.ProtoReflect.Descriptor instead.
func (*AuthResponce) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{3}
}

func (x *AuthResponce) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *IsAdminResponce) GetAdmin() bool {
	if x != nil {
		return x.Admin
	}
	return false
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x56, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x52,
	...
	0x24, 0x0a, 0x0c, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x12,
	...
	0x22, 0x27, 0x0a, 0x0f, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x63, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x05, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x32, 0xa8, 0x01, 0x0a, 0x04, 0x41, 0x75,
	...
	0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x2d, 0x0a,
	...
	0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x07,
	...
	0x6f, 0x6e, 0x63, 0x65, 0x42, 0x11, 0x5a, 0x0f, 0x77, 0x77, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*AuthResponce)(nil),     // 3: auth.AuthResponce
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	3, // 4: auth.Auth.Auth:output_type -> auth.AuthResponce
