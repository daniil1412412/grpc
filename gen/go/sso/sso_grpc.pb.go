...
type AuthClient interface {
	...
	Auth(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*AuthResponce, error)
...
func (c *authClient) Auth(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*AuthResponce, error) {
...
type AuthServer interface {
	...
	Auth(context.Context, *AuthRequest) (*AuthResponce, error)
...
func (UnimplementedAuthServer) Auth(context.Context, *AuthRequest) (*AuthResponce, error) {
